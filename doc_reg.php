...
<body>
	...
	<form class="myform" action="doc_reg.php" method="post">
	    <label><b>How Much Availibility</b></label><br>
		<label><b>Hospital Beds</b></label><br>
		<input name="hospital_beds" id="bedid" type="Number" class="inputvalues" placeholder="Enter number of beds available " required/<br>
		<label><b>plasma_units</b></label><br>
		<input name="Plasma Units" id="plasmaid" type="Number" class="inputvalues" placeholder="Enter number of plasma units available " required/<br>
		<label><b>Doctors Availibility</b></label><br>
		<input name="doct_ava" id="doctorid" type="Number" class="inputvalues" placeholder="Enter number of doctor's available " required/<br>
	...
	<?php
		...
		if(isset($_POST['submit_btn']))
		{
			...
			$beds = $_POST['hospital_beds'];
			$plasma=$_POST['plasma_units'];
			$doctors=$_POST['doct_ava'];
			...
			{
				$query= "select * from doc_reg WHERE username='$username' ";
				...
				{
					$query= "insert into doc_reg (beds,plasma,doctors,username,password) values('$beds','$plasma','$doctors','$username','$password')";
					$query_run=mysqli_query($con,$query);
